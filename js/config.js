...
const SPEED_HARD = 18;
const SPEED_ADVENTURE = 12;
const COLS = WIDTH / GRID;
const ROWS = HEIGHT / GRID;
const APPLES_PER_LEVEL = 5;
const COIN_RATE = 0.7;
// Режим "Приключение": бонус к монетам за риск + параметры появления препятствий
const ADV_COIN_MULT = 1.3;
const ADV_OBSTACLE_MAX = 45;
const ADV_OBSTACLE_START_MS = 4500;
const ADV_OBSTACLE_MIN_MS = 900;
const WHEEL_AD_SPINS_MAX = 2;
