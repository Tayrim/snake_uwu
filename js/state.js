...
let invertedUntil = 0;
let advObstacleCooldown = 0;
let advObstacleQueue = [];
...
// --- РЕВАНШ / x2 МОНЕТЫ ЗА РЕКЛАМУ ---
let reviveUsed = false;
let doubleCoinsUsed = false;
let pendingGameOverCommit = null;

// --- ДОП. СПИНЫ КОЛЕСА ЗА РЕКЛАМУ ---
let wheelExtraUsed = 0;
...
// --- КНОПКИ ---
let BTN_MENU_1 = {}, BTN_MENU_ADV = {}, BTN_MENU_2 = {}, BTN_MENU_3 = {};
let BTN_SHOP = {}, BTN_GIFT = {}, BTN_SETTINGS = {}, BTN_QUESTS = {};
let BTN_WHEEL = {}, BTN_ACH = {}, BTN_SPIN = {}, BTN_SPIN_AD = {};
let BTN_BACK = {};
let BTN_PROFILE = {};
...
let BTN_GO_REVIVE = {}, BTN_GO_X2 = {}, BTN_GO_RESTART = {}, BTN_GO_MENU = {};
let BTN_LW_NEXT = {}, BTN_LW_RETRY = {}, BTN_LW_LIST = {}, BTN_LW_X2 = {};
let DIFF_TABS = [];
let LEVEL_CELLS = [];
let SHOP_ROWS = [];
