...
function loadWheelExtra() {
  const d = loadJSON('snake_wheel_extra', null);
  if (d && d.date === todayStr()) return d.used || 0;
  return 0;
}
function saveWheelExtra(n) { saveJSON('snake_wheel_extra', { date: todayStr(), used: n }); }
